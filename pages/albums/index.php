...
//Página de exibição dos álbuns

require_once '../../db_connect.php';

$sql = "SELECT * FROM albums WHERE excluded = false ORDER BY created_at DESC"; //Selecionando os álbuns ativos em ordem decrescente
        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-light px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto d-flex justify-content-end">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../albums/index.html">Fotos</a>
                    </li>
                    <li class="nav-item">
        ...
        <main class="albums">
            ...
            ?>
                ...
                <div class="card" style="width: 18rem;">
                    <a href="./photos/index.php?album=<?= $album['name'] ?>">
                        <div>
                            <img src="/adm/albums/photos/<?= $album['name'] ?>/cover/<?= $album['cover_name'] ?>" class="card-img-top" alt="Capa do álbum">
                        </div>
                        <div class="card-body">
